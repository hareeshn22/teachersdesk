                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="display table table-centered datatable dt-responsive nowrap" id="lesson">
                                <thead>
                                    <tr>
                                    <tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#lesson').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.lessons.filter') }}",
                    type: "POST",
                    data: function(d) {
