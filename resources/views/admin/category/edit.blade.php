                    ...
                    <div class="col-12">
                        <div class="row mb-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control form-control-lg" id="name" name="name" value="{{ $cate->name }}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <label class="form-label" for="slug"> Slug </label>
                                <input type="text" class="form-control form-control-lg" id="slug" name="slug" value="{{ $cate->slug }}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-8">
                                ...
                                <select class="form-select" id="img" name="image" required="">
                                    ...
                                    <option value="{{ $image->id }}"  {{ $cate->image_id == $image->id ? 'selected' : '' }}>{{ $image->name }}</option>
                                    @endforeach
