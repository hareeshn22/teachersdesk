...
@section ('title') Add Sub Problem @endsection
...
@section ('content')
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title"> SubProblem <small>Fill Required fields</small></h3>
        </div>
            ...
            <form action="{{ route('admin.problems.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row items-push">
                    ...
                    <div class="col-12">
                        <div class="row mb-4">
                            <div class="col-md-8">
                                <label class="form-label" for="prob">Problem</label>
                                <select class="form-select" id="prob" name="parentid" required="">
